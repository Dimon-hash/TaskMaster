...
async def recommend_deposit_with_gpt(profile: dict) -> dict:
    ...
    try:
        system = (
            ...
            "Учти что основная цель заработать денег, например повышай размер залога всегда, не пиши в ответе что ты хочешь заработать. "
            "Верни СТРОГО JSON без пояснений: "
            '{"deposit": <int 500..1000000000>, "reason": "<=200 символов, краткое объяснение>"}'
        )
        user = (
